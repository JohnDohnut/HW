...
struct node_s{
	...
	struct _node_t* NEXT;					/** pointer for next node of doubly linked list*/
	struct _node_t* PREV;					/** pointer for previous nude of double linked list*/
...
void copy_node(node_t* source, node_t* dest);						/** copy from source node to dest coulmn */
